...
//    private InventorySlot detectedSlot; // fallback slot via trigger
...
//        // If not added, try detected trigger slot
...
//    {
//        InventorySlot slot = other.GetComponent<InventorySlot>();
//        if (slot != null && detectedSlot == slot)
//        {
//            detectedSlot = null;
//            //Debug.Log(slot.gameObject.name);
//        }
